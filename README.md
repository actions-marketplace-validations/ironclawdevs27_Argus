...
[![Harness](https://img.shields.io/badge/harness-757%2F757-4ADE80)](test-harness/)
...
npm run test:harness       # 146-block correctness harness — requires Chrome
...
All 757 harness assertions pass (`757/757`) — there are currently no known MCP- or Chrome-layer restrictions. Soft assertions (Lighthouse, performance traces) still require non-headless Chrome and are skipped in headless CI.
...
test-harness/           — 146-block correctness harness, 757 hard assertions, 60 fixture pages

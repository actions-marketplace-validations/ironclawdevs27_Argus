...
- Harness statistics (146 blocks, 757 hard assertions, 67 detection categories)
...
npm run test:harness       # Expected: 757/757 (no permanent failures); INFO logs suppressed via .env.harness

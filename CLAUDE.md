...
- Harness statistics (139 blocks, 664 hard assertions, 67 detection categories)
...
npm run test:harness       # Expected: 664/664 (no permanent failures); INFO logs suppressed via .env.harness

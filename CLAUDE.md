...
- Harness statistics (138 blocks, 653 hard assertions, 63 detection categories)
...
npm run test:harness  # Expected: 650/653 (3 permanent MCP-limited failures)
```

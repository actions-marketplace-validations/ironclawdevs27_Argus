...
- Harness statistics (147 blocks, 762 hard assertions, 67 detection categories)
...
npm run test:harness       # Expected: 762/762 (no permanent failures); INFO logs suppressed via .env.harness

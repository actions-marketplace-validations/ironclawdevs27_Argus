...
- Harness statistics (148 blocks, 832 hard assertions, 67 detection categories)
...
npm run test:harness       # Expected: 832/832 (no permanent failures); INFO logs suppressed via .env.harness

...
- Harness statistics (142 blocks, 688 hard assertions, 67 detection categories)
...
npm run test:harness       # Expected: 688/688 (no permanent failures); INFO logs suppressed via .env.harness

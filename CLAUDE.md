...
- Harness statistics (131 blocks, 592 hard assertions, 59 detection categories)
...
npm run test:harness  # Expected: 589/592 (3 permanent MCP-limited failures)
```

...
- Harness statistics (144 blocks, 738 hard assertions, 67 detection categories)
...
npm run test:harness       # Expected: 738/738 (no permanent failures); INFO logs suppressed via .env.harness

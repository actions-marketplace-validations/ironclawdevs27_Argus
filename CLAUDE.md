...
- Harness statistics (141 blocks, 679 hard assertions, 67 detection categories)
...
npm run test:harness       # Expected: 679/679 (no permanent failures); INFO logs suppressed via .env.harness

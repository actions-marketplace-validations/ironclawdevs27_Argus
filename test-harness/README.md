...
136 test blocks · 626 hard assertions · 60 verified detection categories · 62 fixture pages

> **Coverage note**: 63 detection categories exist in production code. 60 are positively exercised by the harness (blocks [1]–[93] + [127]–[136]). Blocks [94]–[126] cover infrastructure contracts (module APIs, MCP transport, unhappy paths, CLI E2E). Block [127] adds A7 Theme & Dark Mode; block [128] (30 assertions [128a]–[128ad]) adds D9 Design Fidelity (13 mismatch finding types); block [129] adds Web Vitals (LCP/CLS/FCP/TTI/TTFB + bundle size); block [130] adds A8 Visual Regression (pixelmatch baseline comparison); block [131] adds A12 Deep Accessibility (axe-core 4.12 + CVD color blind simulation); block [132] adds N1 HAR Network Baseline; block [133] adds A9 Motion & Animation; block [134] adds A10 Font Loading; block [135] adds A11 Form Validation; block [136] adds GitHub Check Runs (createCheckRun/completeCheckRun + generateReleaseNotes). Remaining untriggered detections tracked in [argus-v6-strategy.md §10](../argus-v6-strategy.md).
...
**Expected output (623/626 — 3 permanent MCP-limited failures, exit code 0):**
...
────────────────────────────────────────────────────────
Results: 623/626 hard assertions passed, 3 failed

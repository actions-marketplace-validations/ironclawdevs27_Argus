...
const docChapters = [
  ...
  },
  {
    num: '05',
    title: 'Test Coverage',
    tagline: '148 blocks, 832 hard assertions, fixture-driven with zero ambiguity',
    sections: [
      {
      ...
      },
      {
        ...
        bullets: [
          ...
          'All 832 hard assertions pass — zero permanent failures',
        ],
      },
      {
        title: 'Known Limits',
...
npm run test:harness  # 832 hard assertions — Chrome required (headless)
# Expected: 832/832 — no permanent failures
      ...
      <div style={{ maxWidth: 1120, margin: '0 auto' }}>
        ...
        >
          ...
          <p style={{ margin: 0, maxWidth: 520, fontSize: 'clamp(0.9rem, 1.3vw, 1.05rem)', color: 'rgba(255,255,255,0.38)', lineHeight: 1.7 }}>
            From a single file to 148 test blocks — the engineering decisions, discoveries, and challenges behind Argus.
          </p>
        </motion.div>
